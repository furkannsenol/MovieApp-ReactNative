import { StyleSheet, Text, View, Image, TouchableWithoutFeedback, Dimensions, Animated, PanResponder } from 'react-native'
...
const FavoriteMovieItem = ({ item, theme, genres }) => {
